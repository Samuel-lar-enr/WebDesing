...
### **HTML:**
- [x] Usa `<!DOCTYPE html>`
- [x] Incluye `<meta charset="UTF-8">`
- [x] Todas las etiquetas semánticas están presentes
- [x] `<header>`, `<nav>`, `<main>`, `<section>`, `<footer>` usados correctamente
- [x] Formulario completo con todos los campos
- [x] Labels asociados con inputs (atributo `for`)
- [x] Pasa validación W3C HTML sin errores

### **CSS:**
- [x] Archivo externo `estilos.css` vinculado
- [x] Usa `box-sizing: border-box`
- [x] Mínimo 5 tipos de selectores diferentes
- [x] Contenedor principal centrado
- [x] Formulario estilizado con pseudo-clases
- [x] Esquema de colores coherente
- [x] Pasa validación W3C CSS sin errores

### **Presentación:**
- [x] La página se ve bien visualmente
- [x] No hay texto ilegible
- [x] Los enlaces funcionan (aunque sean #)
- [x] El formulario muestra validación visual
